describe('doublyLinkedList', function() {
  ...
  it('should designate a new tail when new nodes are added at the tail', function(){
    doublyLinkedList.addToTail(4);
  ...
  it('should designate a new head when new nodes are added at the head', function(){
