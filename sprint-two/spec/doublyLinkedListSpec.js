describe('doublyLinkedList', function() {
  ...
  xit('should have nodes with a previous property', function() {
    doublyLinkedList.addToTail(4);
    expect(doublyLinkedList.head).to.have.property("previous");
  });

  xit('should have methods named "addToHead", "addToTail", "removeHead", "removeTail" and "contains"', function() {
  ...
  xit('should designate a new tail when new nodes are added at the tail', function(){
    doublyLinkedList.addToTail(4);
  ...
  xit('should designate a new head when new nodes are added at the head', function(){
  ...
  xit("should return the value of the former tail when removeTail is called", function(){
    doublyLinkedList.addToTail(4);
